...
import ke.co.hostelplus.hostelplus.db.HostelData;
import ke.co.hostelplus.hostelplus.db.HostelDb;

import ke.co.hostelplus.hostelplus.utils.MainListHandler;
        ...
        fetchData(new MainListHandler() {
            ...
            public void onResponse(String dowload, boolean status, String info) {
                ...
                if (status) {
                    ...
                    EasyRecyclerAdapter e = new EasyRecyclerAdapter(MainActivity.this, MainListHolder.class, hostel);
